...
use fluentbase_sdk::{
    ...
    PRECOMPILE_EIP2935, PRECOMPILE_EVM_RUNTIME, PRECOMPILE_FEE_MANAGER, PRECOMPILE_NITRO_VERIFIER,
    PRECOMPILE_RUNTIME_UPGRADE, PRECOMPILE_UNIVERSAL_TOKEN_RUNTIME, PRECOMPILE_WASM_RUNTIME,
...
/// The upgradeable system contracts, by the name of their address constant.
///
/// The Ethereum precompile addresses are absent on purpose: the node serves them natively, so
/// the release genesis carries no artifact for them and an upgrade there would change nothing.
