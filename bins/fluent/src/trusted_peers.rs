...
pub const MAINNET_TRUSTED_PEERS: [&str; 0] = [];
...
pub const DEVNET_CONSENSUS_URL: &str = "wss://rpc.devnet.fluent.xyz";
pub const TESTNET_CONSENSUS_URL: &str = "wss://rpc.testnet.fluent.xyz";
