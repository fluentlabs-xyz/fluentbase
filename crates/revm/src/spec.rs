//! Contains the `[RwasmSpecId]` type and its implementation.
...
//         match self {
//             Self::GENESIS => SpecId::PRAGUE,
//         }
//     }
//
//     /// Checks if the [`RwasmSpecId`] is enabled in the other [`RwasmSpecId`].
...
//         match s {
//             name::GENESIS => Ok(RwasmSpecId::GENESIS),
...
//         match spec_id {
//             RwasmSpecId::GENESIS => name::GENESIS,
//         }
//     }
// }
//
