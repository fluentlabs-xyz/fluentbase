use crate::{frame::RwasmFrame, RwasmEvm};
use fluentbase_sdk::{Address, Bytes};
use revm::{
    context::{
        result::{EVMError, ExecutionResult, HaltReason, InvalidTransaction, ResultAndState},
        Block, BlockEnv, Cfg, CfgEnv, ContextSetters, ContextTr, JournalOutput, JournalTr,
        Transaction, TxEnv,
    },
    database::EmptyDB,
    handler::{
        instructions::{EthInstructions, InstructionProvider},
        EvmTr, Handler, MainnetHandler, PrecompileProvider, SystemCallTx,
    },
    inspector::{InspectorHandler, JournalExt},
    interpreter::{interpreter::EthInterpreter, InterpreterResult},
    primitives::hardfork::SpecId,
    Context, Database, DatabaseCommit, ExecuteCommitEvm, ExecuteEvm, InspectCommitEvm, InspectEvm,
    Inspector, Journal, MainContext, SystemCallEvm,
};
