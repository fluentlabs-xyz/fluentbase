...
extern "C" {
    ...
    pub(crate) fn _jzkt_get(key32_ptr: *const u8, field: u32, output32_ptr: *mut u8) -> bool;
    ...
    pub(crate) fn _jzkt_update_preimage(
        key32_ptr: *const u8,
        field: u32,
    ...
    pub(crate) fn _jzkt_load(slot32_ptr: *const u8, value32_ptr: *mut u8) -> i32;
