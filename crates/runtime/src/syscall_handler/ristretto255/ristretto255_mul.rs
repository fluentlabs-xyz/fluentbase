use crate::{
    syscall_handler::{syscall_process_exit_code, SyscallCurve25519RistrettoDecompressValidate},
    RuntimeContext,
};
...
pub struct SyscallCurve25519RistrettoMul {}

impl SyscallCurve25519RistrettoMul {
