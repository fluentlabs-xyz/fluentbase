...
pub enum SysFuncIdx {
    ...
    SHA_COMPRESS = 0x0206,
    ED_ADD = 0x0207,
    ED_DECOMPRESS = 0x0208,
    KECCAK_PERMUTE = 0x0209,
    SECP256K1_ADD = 0x020A,
    SECP256K1_DOUBLE = 0x020B,
    SECP256K1_DECOMPRESS = 0x020C,
    BN254_ADD = 0x020E,
    BN254_DOUBLE = 0x020F,
    // COMMIT = 0x0210,
    ...
    // HINT_LEN = 0x02F0,
    // HINT_READ = 0x02F1,
    BLS12381_DECOMPRESS = 0x021C,
    UINT256_MUL = 0x021D,
    BLS12381_ADD = 0x021E,
    BLS12381_DOUBLE = 0x021F,
    BLS12381_FP_ADD = 0x0220,
    BLS12381_FP_SUB = 0x0221,
    BLS12381_FP_MUL = 0x0222,
    BLS12381_FP2_ADD = 0x0223,
    BLS12381_FP2_SUB = 0x0224,
    BLS12381_FP2_MUL = 0x0225,
    BN254_FP_ADD = 0x0226,
    BN254_FP_SUB = 0x0227,
    BN254_FP_MUL = 0x0228,
    BN254_FP2_ADD = 0x0229,
    BN254_FP2_SUB = 0x022A,
    BN254_FP2_MUL = 0x022B,
}
