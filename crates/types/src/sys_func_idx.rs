...
pub enum SysFuncIdx {
    ...
    // EVM precompile crypto (0x09): one call per precompile-level operation, see `CryptoSyscall`
    CRYPTO_BLS12381_G1_ADD = 0x0901,
    CRYPTO_BLS12381_G1_MSM = 0x0902,
    CRYPTO_BLS12381_G2_ADD = 0x0903,
    CRYPTO_BLS12381_G2_MSM = 0x0904,
    CRYPTO_BLS12381_PAIRING_CHECK = 0x0905,
    CRYPTO_BLS12381_MAP_FP_TO_G1 = 0x0906,
    CRYPTO_BLS12381_MAP_FP2_TO_G2 = 0x0907,
    CRYPTO_BN254_G1_ADD = 0x0908,
    CRYPTO_BN254_G1_MUL = 0x0909,
    CRYPTO_BN254_PAIRING_CHECK = 0x090a,
    CRYPTO_SECP256K1_ECRECOVER = 0x090b,
    CRYPTO_SECP256R1_VERIFY = 0x090c,
    CRYPTO_KZG_VERIFY_PROOF = 0x090d,
