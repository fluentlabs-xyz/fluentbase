    ...
    B: ByteOrder,
{
    if T::IS_DYNAMIC {
        ...
        // tail size включает в себя вложенные хедеры!!! он не включает только хедеры для структур
        ...
        // todo: mv this elements offsets to the tail_size
