...
use fluentbase_sdk::{HashMap};
use solana_program::clock::{Epoch, Slot};
use solana_program::pubkey::Pubkey;
use solana_program::{bpf_loader, bpf_loader_deprecated, bpf_loader_upgradeable, loader_v4};
...
impl<'a, 'b, SDK: SharedAPI> LoadedProgram<'a, SDK> {
    ...
    pub fn new_builtin(
        ...
        Self {
            ...
            tx_usage_counter: AtomicU64::new(0),
            program: LoadedProgramType::Builtin(BuiltinProgram::new_builtin(function_registry).into()).into(),
            ix_usage_counter: AtomicU64::new(0),
            latest_access_slot: AtomicU64::new(0),
        }
    }
