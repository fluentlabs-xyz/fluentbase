...
pub mod cap_accounts_data_len {
    solana_program::declare_id!("capRxUrBjNkkCpjrJxPGfPaWijB7q3JoDfsWXAnt46r");
}
...
pub mod stake_redelegate_instruction {
    solana_program::declare_id!("2KKG3C6RBnxQo9jVVrbzsoSh41TDXLK7gBc9gduyxSzW");
}
...
pub mod enable_partitioned_epoch_reward {
    solana_program::declare_id!("41tVp5qR1XwWRt5WifvtSQyuxtqQWJgEK8w91AtBqSwP");
}
...
pub mod cap_accounts_data_size_per_block {
    solana_program::declare_id!("qywiJyZmqTKspFg2LeuUHqcA5nNvBgobqb9UprywS9N");
}
