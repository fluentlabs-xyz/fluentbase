...
fn translate_slice_inner<'a, T: crate::word_size_mismatch::fat_ptr_repr::ElemTypeConstraints>(
    memory_mapping: &MemoryMapping,
    access_type: AccessType,
    vm_addr: u64,
    len: u64,
...
pub fn translate_slice<'a, T: crate::word_size_mismatch::fat_ptr_repr::ElemTypeConstraints>(
    memory_mapping: &MemoryMapping,
    vm_addr: u64,
    len: u64,
    check_aligned: bool,
...
pub fn translate_slice_mut<'a, T: crate::word_size_mismatch::fat_ptr_repr::ElemTypeConstraints>(
    memory_mapping: &MemoryMapping,
    vm_addr: u64,
    len: u64,
    check_aligned: bool,
