use crate::account::{AccountSharedData, BorrowedAccount, ReadableAccount};
use crate::account_utils::StateMut;
use crate::common::{check_loader_id, load_program_from_bytes};
use crate::compute_budget::ComputeBudget;
use crate::error::InstructionError;
use crate::feature_set::FeatureSet;
use crate::helpers::SyscallContext;
use crate::loaded_programs::{LoadedProgram, LoadedProgramType, LoadedProgramsForTxBatch, ProgramRuntimeEnvironments};
...
impl<'a, SDK: SharedAPI> InvokeContext<'a, SDK> {
    ...
    pub fn inc_slots(&mut self, step: u64) {
        self.programs_loaded_for_tx_batch.set_slot(self.programs_modified_by_tx.slot().saturating_add(step));
        self.programs_modified_by_tx.set_slot(self.programs_modified_by_tx.slot().saturating_add(step));
    }
    ...
    fn process_executable_chain(
        ...
        let mut vm = EbpfVm::new(
            ...
            unsafe { core::mem::transmute::<&mut InvokeContext<SDK>, &mut InvokeContext<SDK>>(self) },
...
impl<'a, SDK: SharedAPI> InvokeContext<'a, SDK> {
    ...
    pub fn get_account_with_fixed_root(&self, pubkey: &Pubkey) -> Option<AccountSharedData> {
        ...
        self.transaction_context.accounts.get(idx).and_then(|v| Some(v.borrow().clone()))
    }
    ...
    pub fn load_program(
        ...
        let mut loaded_program = match load_result? {
