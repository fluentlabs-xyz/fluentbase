    ...
    fn try_get_type_len(&self) -> Result<usize, ProgramError> {
        ...
        Ok(match self {
            ...
            ExtensionType::MemoTransfer => {
                unreachable!("unsupported")
                // pod_get_packed_len::<MemoTransfer>()
            }
            ExtensionType::NonTransferable => pod_get_packed_len::<NonTransferable>(),
            ExtensionType::InterestBearingConfig => {
                unreachable!("unsupported")
                // pod_get_packed_len::<InterestBearingConfig>()
            }
            ExtensionType::CpiGuard => {
                unreachable!("unsupported")
                // pod_get_packed_len::<CpiGuard>()
            }
            ExtensionType::PermanentDelegate => {
                unreachable!("unsupported")
                // pod_get_packed_len::<PermanentDelegate>()
            }
            ...
            ExtensionType::TransferHook => {
                unreachable!("unsupported")
                // pod_get_packed_len::<TransferHook>()
            }
            ExtensionType::TransferHookAccount => {
                unreachable!("unsupported")
                // pod_get_packed_len::<TransferHookAccount>()
            }
            ...
            ExtensionType::MetadataPointer => {
                unreachable!("unsupported")
                // pod_get_packed_len::<MetadataPointer>()
            }
            ExtensionType::TokenMetadata => unreachable!(),
            ExtensionType::GroupPointer => {
                unreachable!("unsupported")
                // pod_get_packed_len::<GroupPointer>()
            }
            ...
            ExtensionType::GroupMemberPointer => {
                unreachable!("unsupported")
                // pod_get_packed_len::<GroupMemberPointer>()
            }
            ...
            ExtensionType::ConfidentialMintBurn => {
                unreachable!("unsupported")
                // pod_get_packed_len::<ConfidentialMintBurn>()
            } // #[cfg(test)]
