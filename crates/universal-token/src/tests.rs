use crate::{
    consts::{
        ERR_ALREADY_PAUSED, ERR_ALREADY_UNPAUSED, ERR_DECODE, ERR_INDEX_OUT_OF_BOUNDS,
        ERR_INSUFFICIENT_BALANCE, ERR_INVALID_META_NAME, ERR_INVALID_META_SYMBOL,
        ERR_INVALID_MINTER, ERR_INVALID_RECIPIENT, ERR_MALFORMED_INPUT,
        ERR_MINTABLE_PLUGIN_NOT_ACTIVE, ERR_OVERFLOW, ERR_PAUSABLE_PLUGIN_NOT_ACTIVE,
        ERR_PAUSER_MISMATCH, ERR_UNINIT, ERR_VALIDATION, SIG_ALLOWANCE, SIG_APPROVE,
