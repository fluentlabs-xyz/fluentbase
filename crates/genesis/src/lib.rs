...
pub const GENESIS_CONTRACTS: &[(&str, Address, &[u8])] = &[
    ("fluentbase-contracts-modexp", fluentbase_types::PRECOMPILE_BIG_MODEXP, fluentbase_contracts_modexp::RWASM_BYTECODE),
    ("fluentbase-contracts-blake2f", fluentbase_types::PRECOMPILE_BLAKE2F, fluentbase_contracts_blake2f::RWASM_BYTECODE),
    ("fluentbase-contracts-bn256", fluentbase_types::PRECOMPILE_BN256_ADD, fluentbase_contracts_bn256::RWASM_BYTECODE),
    ("fluentbase-contracts-bn256", fluentbase_types::PRECOMPILE_BN256_MUL, fluentbase_contracts_bn256::RWASM_BYTECODE),
    ("fluentbase-contracts-bn256", fluentbase_types::PRECOMPILE_BN256_PAIR, fluentbase_contracts_bn256::RWASM_BYTECODE),
    ("fluentbase-contracts-erc20", fluentbase_types::PRECOMPILE_ERC20, fluentbase_contracts_erc20::RWASM_BYTECODE),
    ("fluentbase-contracts-evm", fluentbase_types::PRECOMPILE_EVM_RUNTIME, fluentbase_contracts_evm::RWASM_BYTECODE),
    ("fluentbase-contracts-fairblock", fluentbase_types::PRECOMPILE_FAIRBLOCK_VERIFIER, fluentbase_contracts_fairblock::RWASM_BYTECODE),
    ("fluentbase-contracts-identity", fluentbase_types::PRECOMPILE_IDENTITY, fluentbase_contracts_identity::RWASM_BYTECODE),
    ("fluentbase-contracts-kzg", fluentbase_types::PRECOMPILE_KZG_POINT_EVALUATION, fluentbase_contracts_kzg::RWASM_BYTECODE),
    ("fluentbase-contracts-multicall", fluentbase_types::PRECOMPILE_NATIVE_MULTICALL, fluentbase_contracts_multicall::RWASM_BYTECODE),
    ("fluentbase-contracts-nitro", fluentbase_types::PRECOMPILE_NITRO_VERIFIER, fluentbase_contracts_nitro::RWASM_BYTECODE),
    ("fluentbase-contracts-oauth2", fluentbase_types::PRECOMPILE_OAUTH2_VERIFIER, fluentbase_contracts_oauth2::RWASM_BYTECODE),
    ("fluentbase-contracts-ripemd160", fluentbase_types::PRECOMPILE_RIPEMD160, fluentbase_contracts_ripemd160::RWASM_BYTECODE),
    ("fluentbase-contracts-ecrecover", fluentbase_types::PRECOMPILE_SECP256K1_RECOVER, fluentbase_contracts_ecrecover::RWASM_BYTECODE),
    ("fluentbase-contracts-sha256", fluentbase_types::PRECOMPILE_SHA256, fluentbase_contracts_sha256::RWASM_BYTECODE),
    ("fluentbase-contracts-webauthn", fluentbase_types::PRECOMPILE_WEBAUTHN_VERIFIER, fluentbase_contracts_webauthn::RWASM_BYTECODE),
];
