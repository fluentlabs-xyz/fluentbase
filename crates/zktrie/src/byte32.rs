use crate::{fr_from_big_endian, fr_from_usize, Fr, HashScheme, HASH_DOMAIN_BYTE32};
...
impl Byte32 {
    ...
    pub fn hash<H: HashScheme>(&self) -> Result<Fr, String> {
        ...
        let domain = fr_from_usize(HASH_DOMAIN_BYTE32);
    ...
    // 0x0000000000000000000000000000000000000000001000000001020304030201
    // 0x0000000000000000000000000000000000000000000000010203060302010000
