...
pub fn _evm_log4<CR: ContextReader, AM: SovereignAPI>(
    _cr: &CR,
    _am: &AM,
    ...
    _topic32_4_offset: *const u8,
) {
    // const TOPICS_COUNT: usize = 4;
    ...
    // unsafe { ptr::copy(topic32_4_offset, topics[3].as_mut_ptr(), 1) }
