...
use fuel_core_storage::{StorageInspect, StorageMutate};
...
use fuel_core_types::fuel_tx::{AssetId, ConsensusParameters};
use crate::fvm::types::WasmStorage;
use crate::helpers_fvm::fvm_transact_commit;
...
mod tests {
    ...
    pub(crate) fn journal_state() -> JournalState<TestingContext> {
    ...
    pub(crate) type TestingSDK = JournalState<TestingContext>;
