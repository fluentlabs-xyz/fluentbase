...
// use revm_primitives::{Bytecode, CancunSpec, CreateScheme, Env, BLOCK_HASH_HISTORY,
// MAX_CODE_SIZE};
//
...
// InstructionResult::CreateContractStartingWithEF,         ExitCode::FatalExternalError =>
// InstructionResult::FatalExternalError,         // TODO(dmitry123): "what's proper unknown error
// code mapping?"         _ => InstructionResult::OutOfGas,
//     }
// }
//
...
// ExitCode::CreateContractStartingWithEF,         InstructionResult::FatalExternalError =>
// ExitCode::FatalExternalError,         _ => ExitCode::UnknownError,
//     }
// }
//
...
//         debug_assert_eq!(code_hash.data, bytecode.hash_slow());
//         self.sdk
...
//
//                     let call_result = match inputs.scheme {
...
//                     let create_result = self.sdk.create(
//                         inputs.gas_limit,
//                         match inputs.scheme {
...
//                     );
//                     let create_outcome = match create_result.status {
//                         SyscallStatus::Ok => {
//                             let result = InterpreterResult::new(
//                                 InstructionResult::Stop,
//                                 Bytes::default(),
//                                 interpreter.gas,
//                             );
//                             CreateOutcome::new(result, Some(create_result.data))
//                         }
...
//         }
//
//         // if bytecode starts with 0xEF or exceeds MAX_CODE_SIZE then return the corresponding
// error         if !result.output.is_empty() && result.output.first() == Some(&0xEF) {
...
//         let bytecode =
// hex!("60806040526105ae806100115f395ff3fe608060405234801561000f575f80fd5b506004361061003f575f3560e0"
...
//         {
//
// native_sdk.set_input(hex!("
// "
