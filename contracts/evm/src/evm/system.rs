...
pub fn keccak256<SDK: SharedAPI>(interpreter: &mut Interpreter, sdk: &mut SDK) {
    ...
    let hash = if len == 0 {
        ...
        let input = interpreter.shared_memory.slice(from, len);
        sdk.keccak256(input)
    };
    *len_ptr = hash.into();
}

pub fn address<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::BASE);
    push_b256!(interpreter, interpreter.contract.target_address.into_word());
}

pub fn caller<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::BASE);
    push_b256!(interpreter, interpreter.contract.caller.into_word());
}

pub fn codesize<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::BASE);
    push!(interpreter, U256::from(interpreter.contract.bytecode.len()));
}

pub fn codecopy<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
...
pub fn calldataload<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
...
pub fn calldatasize<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::BASE);
    push!(interpreter, U256::from(interpreter.contract.input.len()));
}

pub fn callvalue<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::BASE);
    push!(interpreter, interpreter.contract.call_value);
}

pub fn calldatacopy<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
...
pub fn returndatasize<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::BASE);
    push!(
        interpreter,
...
/// EIP-211: New opcodes: RETURNDATASIZE and RETURNDATACOPY
pub fn returndatacopy<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
...
pub fn returndataload<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
...
pub fn gas<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::BASE);
