use crate::utils::{read_i16, read_u16};
...
pub fn rjump<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
...
pub fn rjumpi<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    require_eof!(interpreter);
...
pub fn rjumpv<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    require_eof!(interpreter);
    gas!(interpreter, gas::CONDITION_JUMP_GAS);
...
pub fn jump<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::MID);
    pop!(interpreter, target);
    jump_inner(interpreter, target);
}

pub fn jumpi<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
...
pub fn jumpdest_or_nop<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::JUMPDEST);
}

pub fn callf<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    require_eof!(interpreter);
...
pub fn retf<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    require_eof!(interpreter);
...
pub fn jumpf<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    require_eof!(interpreter);
    gas!(interpreter, gas::LOW);
...
pub fn pc<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    gas!(interpreter, gas::BASE);
...
pub fn ret<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    return_inner(interpreter, InstructionResult::Return);
}

/// EIP-140: REVERT instruction
pub fn revert<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    return_inner(interpreter, InstructionResult::Revert);
}

/// Stop opcode. This opcode halts the execution.
pub fn stop<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    interpreter.instruction_result = InstructionResult::Stop;
}

/// Invalid opcode. This opcode halts the execution.
pub fn invalid<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
    interpreter.instruction_result = InstructionResult::InvalidFEOpcode;
}

/// Unknown opcode. This opcode halts the execution.
pub fn unknown<SDK: SharedAPI>(interpreter: &mut Interpreter, _sdk: &mut SDK) {
...
mod test {
    ...
    use revm_interpreter::{
        ...
        primitives::{bytes, eof::TypesSection, Bytecode, Eof, PragueSpec},
        DummyHost,
        FunctionReturnFrame,
        Gas,
        Interpreter,
