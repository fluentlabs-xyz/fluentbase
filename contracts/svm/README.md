...
Solana VM (SVM) adapter contract. Bridges Fluentbase contracts to Solana runtime primitives, enabling execution of
Solana programs and Token‑2022 flows from within the Fluentbase environment.
