(module
  ...
  (import "env" "_crypto_secp256k1_verify" (func $_crypto_secp256k1_verify (type 5)))
  ...
  (func $_ZN4core3fmt3num50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$i32$GT$3fmt17h15a0f8526d63e75aE (type 1) (param i32 i32) (result i32)
    ...
    call $_ZN4core5slice5index26slice_start_index_len_fail17h59fa6bdf0dc3c782E
    unreachable)
  (func $_ZN4core3fmt3num3imp7fmt_u6417h180980c8a51ed901E (type 7) (param i64 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 4)
  (func $_ZN4core3fmt9Formatter12pad_integral17h41b3aea88223bfe6E (type 8) (param i32 i32 i32 i32 i32 i32) (result i32)
