...
pub fn mload<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
...
pub fn mstore<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::VERYLOW);
...
pub fn mstore8<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::VERYLOW);
    pop!(interpreter, index, value);
    let index = as_usize_or_fail!(interpreter, index);
...
pub fn msize<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::BASE);
    // push!(interpreter, U256::from(interpreter.shared_memory.len()));
}

// EIP-5656: MCOPY - Memory copying instruction
pub fn mcopy<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, _host: &mut H) {
