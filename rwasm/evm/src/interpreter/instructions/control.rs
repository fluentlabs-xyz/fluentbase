...
pub fn jump<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
...
pub fn jumpi<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
...
pub fn jumpdest<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::JUMPDEST);
}

pub fn pc<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
...
#[inline(always)]
fn return_inner(interpreter: &mut Translator<'_>, result: InstructionResult) {
    // zero gas cost
...
pub fn ret<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    return_inner(interpreter, InstructionResult::Return)
}

/// EIP-140: REVERT instruction
pub fn revert<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, _host: &mut H) {
    check!(interpreter, BYZANTIUM);
    return_inner(interpreter, InstructionResult::Revert)
}

pub fn stop<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    interpreter.instruction_result = InstructionResult::Stop;
}

pub fn invalid<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    interpreter.instruction_result = InstructionResult::InvalidFEOpcode;
}

pub fn not_found<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
