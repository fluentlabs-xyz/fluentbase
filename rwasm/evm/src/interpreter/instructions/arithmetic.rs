...
pub fn wrapped_add<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
    *op2 = op1.wrapping_add(*op2);
}

pub fn wrapping_mul<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::LOW);
    pop_top!(interpreter, op1, op2);
    *op2 = op1.wrapping_mul(*op2);
}

pub fn wrapping_sub<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
    *op2 = op1.wrapping_sub(*op2);
}

pub fn div<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::LOW);
    pop_top!(interpreter, op1, op2);
    if *op2 != U256::ZERO {
...
pub fn sdiv<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::LOW);
    pop_top!(interpreter, op1, op2);
    *op2 = i256_div(op1, *op2);
}

pub fn rem<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::LOW);
    pop_top!(interpreter, op1, op2);
    if *op2 != U256::ZERO {
...
pub fn smod<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::LOW);
    pop_top!(interpreter, op1, op2);
    if *op2 != U256::ZERO {
...
pub fn addmod<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::MID);
    pop_top!(interpreter, op1, op2, op3);
    *op3 = op1.add_mod(op2, *op3)
}

pub fn mulmod<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::MID);
    pop_top!(interpreter, op1, op2, op3);
    *op3 = op1.mul_mod(op2, *op3)
}

pub fn exp<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, _host: &mut H) {
    pop_top!(interpreter, op1, op2);
...
pub fn signextend<H: Host>(interpreter: &mut Translator<'_>, _host: &mut H) {
    // gas!(interpreter, gas::LOW);
    pop_top!(interpreter, op1, op2);
    if op1 < U256::from(32) {
