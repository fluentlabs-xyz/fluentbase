...
use crate::interpreter::inner_models::{
    CallContext, CallInputs, CallScheme, CreateInputs, Transfer,
};
use crate::interpreter::instruction_result::InstructionResult;
use crate::interpreter::interpreter::{Translator, MAX_INITCODE_SIZE};
use crate::primitives::{Address, Bytes, B256, U256};
use crate::{return_ok, return_revert};
use alloc::{boxed::Box, vec::Vec};
use core::cmp::min;

pub fn balance<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
...
/// EIP-1884: Repricing for trie-size-dependent opcodes
pub fn selfbalance<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
...
pub fn extcodesize<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
    pop_address!(interpreter, address);
...
pub fn extcodehash<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
...
pub fn extcodecopy<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
    pop_address!(interpreter, address);
...
pub fn blockhash<H: Host>(interpreter: &mut Translator<'_>, host: &mut H) {
...
pub fn sload<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
...
pub fn sstore<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
...
pub fn tstore<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
...
pub fn tload<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
    // check!(interpreter, CANCUN);
    // gas!(interpreter, gas::WARM_STORAGE_READ_COST);
...
pub fn log<const N: usize, H: Host>(interpreter: &mut Translator<'_>, host: &mut H) {
    // check_staticcall!(interpreter);
...
pub fn selfdestruct<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
    // check_staticcall!(interpreter);
...
pub fn call<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
    call_inner::</*SPEC, */ H>(CallScheme::Call, interpreter, host);
}

pub fn call_code<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
    // call_inner::<SPEC, H>(CallScheme::CallCode, interpreter, host);
}

pub fn delegate_call<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
    // call_inner::<SPEC, H>(CallScheme::DelegateCall, interpreter, host);
}

pub fn static_call<H: Host /* , SPEC: Spec */>(interpreter: &mut Translator<'_>, host: &mut H) {
