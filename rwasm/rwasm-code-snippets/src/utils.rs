...
pub(crate) fn split_u256_be(u256: U256) -> (u64, u64, u64, u64) {
    let limb0 = u256.0[3];
    let limb1 = u256.0[2];
    let limb2 = u256.0[1];
    let limb3 = u256.0[0];
...
pub(crate) fn combine_u64_be(u64_0: u64, u64_1: u64, u64_2: u64, u64_3: u64) -> U256 {
...
pub(crate) fn combine256_tuple_be(a: &(u64, u64, u64, u64)) -> U256 {
