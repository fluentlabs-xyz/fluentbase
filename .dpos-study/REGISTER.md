...
- Ход по плану 09-04 (INDEX): — (добавлена 09-09 по итогу Э3.2; кандидат в Э5 рядом с П-2 — σ-доставка по раунду — и в Э3.4 Ex-19 как девнет-подтверждение).
...
- **Статус 2026-09-09:** открыта — «before»-тест есть (`a_rotated_out_node_without_the_live_tee_parks`, `ad9ccd02`: парковка на 95 при `re_jump: None`), правки нет. _Источник:_ history/E3-2-STAND-4.md §5.1, §11
