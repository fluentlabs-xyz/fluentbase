...
impl ExecutionState {
    pub fn to_u64(&self) -> u64 {
        match self {
            ...
            ExecutionState::WASM_LOCAL_GET => 10,
            ExecutionState::WASM_LOCAL_SET => 11,
            ExecutionState::WASM_LOCAL_TEE => 12,
            ExecutionState::WASM_REL => 13,
            ExecutionState::WASM_SELECT => 14,
            ExecutionState::WASM_STORE => 15,
            ExecutionState::WASM_TEST => 16,
            ExecutionState::WASM_UNARY => 17,
            ExecutionState::WASM_REFFUNC => 18,
            ExecutionState::WASM_TABLE_COPY => 19,
            ExecutionState::WASM_TABLE_FILL => 20,
            ExecutionState::WASM_TABLE_GET => 21,
            ExecutionState::WASM_TABLE_GROW => 22,
            ExecutionState::WASM_TABLE_INIT => 23,
            ExecutionState::WASM_TABLE_SET => 24,
            ExecutionState::WASM_TABLE_SIZE => 25,
            ExecutionState::WASM_BITWISE => 26,
            ExecutionState::WASM_EXTEND => 27,
            ExecutionState::WASM_MEMORY_COPY => 28,
            ExecutionState::WASM_MEMORY_GROW => 29,
            ExecutionState::WASM_MEMORY_SIZE => 30,
            ExecutionState::WASM_MEMORY_FILL => 31,
            ExecutionState::WASM_MEMORY_INIT => 32,
            ExecutionState::WASM_UNREACHABLE => 33,
            ExecutionState::WASM_CONSUME_FUEL => 34,
            ExecutionState::WASM_SHIFT => 35,
            ExecutionState::WASM_RETURN => 36,
        }
    }
    ...
    pub fn responsible_opcodes(&self) -> Vec<Instruction> {
        match self {
            ...
            Self::WASM_LOCAL_GET => vec![Instruction::LocalGet(Default::default())],
            Self::WASM_LOCAL_SET => vec![Instruction::LocalSet(Default::default())],
            Self::WASM_LOCAL_TEE => vec![Instruction::LocalTee(Default::default())],
